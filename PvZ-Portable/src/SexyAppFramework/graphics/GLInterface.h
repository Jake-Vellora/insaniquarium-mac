...
// Saver host hooks: when a ScreenSaverView owns the GL context there is no
// SDL window; it supplies the present call and backing drawable size here.
extern void (*gGLSwapHook)();
extern int gGLHostDrawableWidth;
extern int gGLHostDrawableHeight;
extern long gGLFlushCount;
extern bool gGLForceContextReinit;
